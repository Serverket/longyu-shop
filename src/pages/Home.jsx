import heroImg from "/src/assets/images/aniv.png";
...
import smilingFace from "/src/assets/images/24.jpg";
  ...
  return (
    <>
      <section>
        ...
        <Container className="flex flex-col items-center md:flex-row mt-9">
          <div className="max-w-full md:w-1/2 shrink-0">
            ...
            <h1 className="text-4xl font-medium tracking-tighter text-black md:text-7xl font-headings mb-7 md:mb-9">
              <span className="ml-8 md:ml-14">Tienda de</span> <br />
              <span className="text-5xl font-extrabold md:text-8xl">
                productos asiáticos <br />
              </span>
              <span className="ml-20 md:ml-40">a nivel nacional.</span>
            </h1>

            <p className="leading-5 max-w-prose">
              Conoce los olores y los sabores <b>de toda Asia</b>.
              <br></br>
              Nuestra variedad viene de los productos más selectos provenientes de China, Corea, Japón, Tailandia, Indonesia y sus alrededores.
            </p>

            <Link
              to="/shop"
              className="inline-flex mt-12 mb-10 align-middle btn-primary hover:bg-green-300 gap-x-3"
            >
              COMIENZA A COMPRAR
              <span>
                <svg
          ...
          {/* second col */}
          <div className="relative mt-10 md:mt-0 grow">
            {/* <img
              src={lipsImg}
              alt=""
      ...
      <Marquee
        className="text-4xl font-medium tracking-tighter text-white bg-black md:text-7xl font-headings whitespace-nowrap"
        content="EL SABOR DE ASIA EN TU MESA"
      />

      <Container
        as="section"
        className="flex flex-col-reverse items-center mt-14 md:mt-24 mb-14 md:flex-row gap-14 md:gap-36"
      >
        <div className="flex flex-col items-center w-full max-w-lg shrink-0">
          <img src={smilingFace} alt="" className="max-w-xs md:max-w-lg" />
          <Link to="/shop" className="my-5 hover:bg-green-300 btn-primary">
            ÚNETE A LA EXPERIENCIA
          </Link>
        </div>

        <div>
          <h2 className="text-4xl tracking-tight mb-9">
      ...
      <Container
        as="section"
        className="flex flex-col items-center my-10 md:flex-row md:my-32"
      >
        <div className="text-center grow md:text-left">
          <span className="block mb-2 tracking-wider text-gray-600">
      ...
      <Container as="section" className="py-10 md:py-20">
        <h2 className="mb-10 text-4xl tracking-tight md:text-5xl">
          World-class <span className="font-extrabold">composable businesses.</span>
        </h2>

        <div className="flex flex-col text-sm leading-snug text-gray-700 md:flex-row gap-x-16">

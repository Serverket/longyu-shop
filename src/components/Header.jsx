...
export function Header({ variant = "light" }) {
  ...
  return (
    <>
      ...
      >
        <div className="w-4/12 h-full grow">
          <NavLink to="/">
            <img
              src={Logo}
              alt="Longyu logo"
              className="h-full transition-colors duration-200 w-28 md:w-52"
            />
          </NavLink>
        </div>

        <div className="hidden w-4/12 max-w-lg grow lg:block">
          <SearchBar
            icon={
              <svg
                fill="none"
        ...
        <div className="flex items-center justify-end w-4/12 grow">
          <nav>
            <ul className="flex items-center text-sm font-medium row gap-x-5 lg:gap-x-16">
              ...
              <li className="flex items-center">
                ...
                >
                  <svg
                    className="w-8 h-8 fill-none stroke-inherit"
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
                  >
  ...
  return (
    <>
      ...
      >
        ...
        <hr className="my-6 bg-gray-300 border-transparent" />
